...
step 1- Create folder on your local machine
step 2- Open that folder in VS Code
step 3- run command: git init (This will initialize your git. Prerequisite is git is installed and github is configured)
step 4- Perform your operations by creating folders/files
...
step 12- Finally push your folder/file to github. run: git push -u origin main
